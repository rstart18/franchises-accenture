...
public final class constants {
    ...
    public static final String PATH_BRANCH_PRODUCT = "/api/v1/branchProduct";
    public static final String PATH_BRANCH = "/api/v1/branch";
    public static final String PATH_FRANCHISE = "/api/v1/franchise";
//    public static final String PATH_GET_ALL_USERS = "/api/v1/user";
//    public static final String PATH_GET_BY_ID = "/api/v1/user/{id}";
//    public static final String PATH_USER_GET_BY_NAME = "/api/v1/user/search/{name}";
